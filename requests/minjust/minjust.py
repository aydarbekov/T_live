...
# with open('minjust.csv', 'w', newline='') as file:
...
while True:
    ...
    for tr in trs:
        link = tr.find('a')
        href = link.get('href')
        # print(load_link('https://register.minjust.gov.kg/' + href))
        ...
        sibling_apartment_number = detail_html.find('span', text='16. № квартиры (офиса, комнаты и т.п.)')
